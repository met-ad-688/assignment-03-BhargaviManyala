...
## Industries Table
`INDUSTRY_ID (Primary Key)`, `NAICS_2022_6`, `NAICS_2022_6_NAME`, `SOC_5`, `SOC_5_NAME`,`LOT_SPECIALIZED_OCCUPATION_NAME`,`LOT_OCCUPATION_GROUP`,`NAICS2_NAME`
...
industries_df = (
    df.select(
        ...
        "SOC_5_NAME",
        "LOT_OCCUPATION_NAME",
        "LOT_SPECIALIZED_OCCUPATION_GROUP"   
    )
    .distinct()
...
industries_df.select(
    count(when(col("LOT_SPECIALIZED_OCCUPATION_NAME").isNull(), 1)).alias("missing_LOT"),
    count(when(col("LOT_V6_SPECIALIZED_OCCUPATION_NAME").isNull(), 1)).alias("missing_LOT_V6")
).show()

# Count differences
industries_df.filter(col("LOT_SPECIALIZED_OCCUPATION_NAME") != col("LOT_V6_SPECIALIZED_OCCUPATION_NAME")).count()
...
from pyspark.sql.functions import monotonically_increasing_id, col, count, when
...
industries_df = (
    df.select(
        ...
        "LOT_SPECIALIZED_OCCUPATION_GROUP",
        "LOT_V6_SPECIALIZED_OCCUPATION_NAME"   # ✅ add this column
    )
    .distinct()
    .withColumn("INDUSTRY_ID", monotonically_increasing_id())
    .select(
        ...
        "LOT_OCCUPATION_NAME",
        "LOT_SPECIALIZED_OCCUPATION_GROUP",
        "LOT_V6_SPECIALIZED_OCCUPATION_NAME"   # ✅ keep it here
    )
    .orderBy("INDUSTRY_ID")
)
