...
*I referred Claude Sonnet 4 which is included in the AI Prompt file.

`INDUSTRY_ID (Primary Key)`, `NAICS_2022_6`, `NAICS_2022_6_NAME`, `SOC_5`, `SOC_5_NAME`,`NAICS2_NAME`
...
`ID (Primary Key)`,  `COMPANY_ID (FK to companies)`, `INDUSTRY_ID (FKto industries)`, `EMPLOYMENT_TYPE_NAME`, `REMOTE_TYPE_NAME`, ,`MIN_YEARS_EXPERIENCE`, `MAX_YEARS_EXPERIENCE`, `SALARY`, `SALARY_FROM`,`SALARY_TO`, `LOCATION_ID (FK to locations)`, `POSTED`, `EXPIRED`, `DURATION`,`ONET_NAME`,`EDUCATION_LEVELS_NAME`,`LOT_V6_SPECIALIZED_OCCUPATION_NAME`
